...
### Tools
  - https://github.com/frdel/agent-zero/tree/main/python/tools
  - [Function calling and Structured Outputs](https://huggingface.co/burtenshaw/Kimi-K2-notebooks)

### MCP
  - [Connect LLMs to MCP Servers](https://github.com/mcp-use/mcp-use)
